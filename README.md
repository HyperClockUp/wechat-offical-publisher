...
一个功能强大的微信公众号文章自动发布工具，支持 Markdown 转换、网络图片上传、多公众号管理和 MCP 协议集成。
...
#### 🎉 新功能
- ✨ 新增网络图片上传功能，支持通过 URL 上传封面图片和文章图片
- 🔧 简化多公众号管理，移除复杂的账号概念，只保留核心的 token 区分功能
- 🚀 优化 MCP 服务器实现，移除不必要的账号管理工具

#### 🐛 修复
- 🔨 修复 MCP 服务器的语法错误和重复方法定义
- 🛠️ 优化 TokenManager 实现，移除未使用的变量

#### 📚 文档
- 📖 更新 README.md，添加详细的功能说明和使用示例
- 🗂️ 清理项目根目录，移除多余的文档文件
